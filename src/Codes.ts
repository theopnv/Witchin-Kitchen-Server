export class Codes {
  ...
  static LAUNCH_INGREDIENT_POLL_SUCCESS = 330;
  static LAUNCH_INGREDIENT_POLL_ERROR = 331;

  static STOP_INGREDIENT_POLL_SUCCESS = 340;
  static STOP_INGREDIENT_POLL_ERROR = 341;

  static VOTE_INGREDIENT_SUCCESS = 350;
  static VOTE_INGREDIENT_ERROR = 351;
}